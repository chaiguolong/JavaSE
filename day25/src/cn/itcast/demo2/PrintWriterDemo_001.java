 ...
 */
public class PrintWriterDemo_001{
    ...
    public static void function_3() throws FileNotFoundException{
        FileOutputStream fos = new FileOutputStream("/Users/mymac/Desktop/5.txt");
    ...
    public static void function_2() throws FileNotFoundException{
        FileOutputStream fos = new FileOutputStream("/Users/mymac/Desktop/3.txt");
        PrintWriter pw = new PrintWriter(fos);
        pw.println("打印流");
        pw.close();
    }
    ...
    public static void function_1() throws FileNotFoundException{
        PrintWriter pw = new PrintWriter("/Users/mymac/Desktop/2.txt");
        pw.println(3.5);
        pw.close();
    }
    ...
    public static void function() throws FileNotFoundException{
        File file = new File("/Users/mymac/Desktop/1.txt");
